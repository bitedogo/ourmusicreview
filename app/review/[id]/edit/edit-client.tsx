          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 truncate text-sm text-[var(--color-text-secondary)]">
              <ArtistNameLink
                ...
                className="max-w-full truncate text-left text-sm text-[var(--color-text-secondary)] transition hover:text-[var(--color-brand-primary)] hover:underline disabled:cursor-wait disabled:no-underline"
              />
            </p>
          </div>
        </div>
