  ...
  return (
    ...
    >
      <div className="w-full">
        ...
        <article className="rounded-b-[var(--featured-cover-radius)] border border-[var(--color-border)] bg-white px-[var(--today-album-content-padding-x-mobile)] py-[var(--today-album-content-padding-y-mobile)] shadow-sm sm:h-[var(--today-album-card-height)] sm:w-[var(--today-album-card-width)] sm:max-w-full sm:rounded-tr-[var(--featured-cover-radius)] sm:px-[var(--today-album-content-padding-x-desktop)] sm:py-[var(--today-album-content-padding-y-desktop)]">
          {activeAlbum ? (
